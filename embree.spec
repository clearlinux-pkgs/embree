...
Version  : 3.13.4
Release  : 22
URL      : https://github.com/embree/embree/archive/v3.13.4/embree-3.13.4.tar.gz
Source0  : https://github.com/embree/embree/archive/v3.13.4/embree-3.13.4.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : Apache-2.0 BSD-3-Clause MIT
Requires: embree-filemap = %{version}-%{release}
...
%package filemap
Summary: filemap components for the embree package.
Group: Default

%description filemap
filemap components for the embree package.
...
%prep
%setup -q -n embree-3.13.4
cd %{_builddir}/embree-3.13.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662567986
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/cmake/embree-3.13.4/embree-config-version.cmake
/usr/lib64/cmake/embree-3.13.4/embree-config.cmake
/usr/lib64/cmake/embree-3.13.4/embree-targets-relwithdebinfo.cmake
/usr/lib64/cmake/embree-3.13.4/embree-targets.cmake
/usr/lib64/glibc-hwcaps/x86-64-v3/libembree3.so
/usr/lib64/glibc-hwcaps/x86-64-v4/libembree3.so
...
%files filemap
%defattr(-,root,root,-)
/usr/share/clear/filemap/filemap-embree

%files lib
%defattr(-,root,root,-)
/usr/lib64/glibc-hwcaps/x86-64-v3/libembree3.so.3
/usr/lib64/glibc-hwcaps/x86-64-v3/libembree3.so.3.13.4
/usr/lib64/glibc-hwcaps/x86-64-v4/libembree3.so.3
/usr/lib64/glibc-hwcaps/x86-64-v4/libembree3.so.3.13.4
/usr/lib64/libembree3.so.3
/usr/lib64/libembree3.so.3.13.4
